...
<head>
    ...
    <meta property="og:image" content="https://thehelpbook.org/assets/pets.jpg">
    ...
    <meta name="twitter:image" content="https://thehelpbook.org/assets/pets.jpg">
...
<body>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background-image: url('./assets/pets.jpg'); /* Placeholder for education background */
...
?>
    ...
    <section class="hero animals-hero">
        ...
        <a href="./join.php"><i class="fa-solid fa-plus"></i>&nbsp;Join Us</a>
    </section>
...
<div class="adoptList">
  <div class="cardContains">
    <div class="adoption-card">
        <div class="carousel2">
            <img src="./assets/bella1.jpg" class="active" alt="Bella image 1">
        </div>
        <h2>Meet Bella!</h2>
        ...
        <a class="register adopt-button" href="/adoptSpec.php">Adopt</a>
    </div>
 </div>
</div>
...
<div class="shareContainer">
 <!-- WhatsApp Share Button -->
    ...
    <section class="adopt openbtn" id="adopt">
        <div class="img">
            <img src="./assets/new/dog.jpg" alt="">
        </div>
        <div class="content">
            <h2>Donate</h2>
            ...
            <span class="register"><a href="adoptForm.php">Donate A Pet</a></span>
        </div>
    </section>
    ...
    <section class="foster openbtn" id="foster">
        <div class="img">
            <img src="./assets/new/cow.jpg" alt="">
        </div>
        <div class="content">
            <h2>Foster</h2>
            ...
            <span class="register"><a href="./fosterForm.php">Become a Foster Parent</a></span>
        </div>
    </section>
    ...
    <section class="support openbtn" id="support" style="margin-top: -10px;">
        <div class="img">
            <img src="./assets/new/bird.jpg" alt="">
        </div>
        <div class="content">
            <h2>Support</h2>
            <p>"Donors are essential to our mission. With your support, we can provide veterinary care, food, and shelter to animals in need. Be part of our mission to improve the lives of countless animals and promote compassionate care."</p>
            <span class="register"><a href="./donate.php">Donate for Animals</a></span>
        </div>
    </section>
    ...
    <!-- Quote Section -->
      ...
      <div class="quote-section">
                <div class="quote-content">
                    <img src="./assets/ratantata400.jpg" alt="Food Initiative Quote" class="quote-image">
        ...
        shareButton.addEventListener('click', () => {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'Meet Bella! Bella is a playful, affectionate friend looking for a home.',
                    url: 'https://www.thehelpbook.org/adoptSpec.php'
                })
