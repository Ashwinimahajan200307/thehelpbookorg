...
<head>
    ...
    <meta property="og:image" content="https://thehelpbook.org/assets/env.jpg">
    ...
    <meta name="twitter:image" content="https://thehelpbook.org/assets/env.jpg">
...
<body>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background-image: url('./assets/env.jpg'); /* Placeholder for education background */
    ...
    <section class="hero env">
        ...
        <a href="./notify.php"><i class="fa-solid fa-check"></i>&nbsp;Notify Later...</a>
          ...
          <section class="community openbtn" id="community">
              <div class="img">
                  <img src="./assets/new/cleaning1.jpg" alt="Community Clean-up">
              </div>
              <div class="content">
          ...
          <section class="wildlife openbtn" id="wildlife">
              <div class="img">
                  <img src="./assets/new/cleaning2.jpg" alt="Wildlife Conservation">
              </div>
 ...
 -->
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 180"><path fill="#f2effd" fill-opacity="1" d="M0,32L48,48C96,64,192,96,288,96C384,96,480,64,576,58.7C672,53,768,75,864,90.7C960,107,1056,117,1152,106.7C1248,96,1344,64,1392,48L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
          ...
          <section class="awareness openbtn" id="awareness">
              <div class="img">
                  <img src="./assets/new/cleaning3.jpg" alt="Environmental Awareness">
              </div>
              <div class="content">
          ...
          <section class="clean-energy openbtn">
              <div class="img">
                  <img src="./assets/env.jpg" alt="Clean Energy Initiatives">
              </div>
              <div class="content right">
                  ...
                  <span class="register"><a href="./donate.php">Get Involved</a></span>
              </div>
          </section>
    ...
    <div class="quote-section">
        <div class="quote-content">
            <img src="./assets/mahatmagandhi.jpg" alt="Dr. A.P.J. Abdul Kalam" class="quote-image">
