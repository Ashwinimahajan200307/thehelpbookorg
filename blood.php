...
<body>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background-image: url('./assets/blooddon.jpg'); /* Placeholder for education background */
    ...
    <section class="hero blood">
        ...
        <a href="./notify.php"><i class="fa-solid fa-check"></i>&nbsp;Notify Later...</a>
          ...
          <section class="community openbtn" id="community">
              <div class="img">
                  <img src="./assets/blood0.jpg" alt="Community Clean-up">
              </div>
              <div class="content">
                  ...
                  <span class="register"><a href="./blooddonation.php">Donate</a></span>
              </div>
          </section>
          ...
          <section class="wildlife openbtn" id="wildlife">
              <div class="img">
                  <img src="./assets/blood1.jpg" alt="Wildlife Conservation">
              </div>
              <div class="content right">
                  ...
                  <span class="register"><a href="./bloodrequests.php">Request</a></span>
              </div>
          </section>
